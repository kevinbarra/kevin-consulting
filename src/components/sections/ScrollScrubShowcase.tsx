...
const projects = [
  {
    id: 0,
    title: "Kofii",
    subtitle: "Orquestación Móvil & Lealtad",
    description: "SaaS de pedidos anticipados y fidelización para cafeterías de especialidad. Conectado a un motor de POS centralizado que procesa transacciones en menos de 150ms.",
    tags: ["React Native", "Node.js", "Redis", "PostgreSQL"],
    metric: "12,000+ pedidos mensuales",
    url: "#",
    image: "/kofii.png",
  ...
  {
    id: 1,
    title: "Fulanos Barber",
    subtitle: "Orquestador de Reservas & POS",
    description: "Plataforma de agendamiento y punto de venta para barberías premium. Incluye asignación dinámica de barberos, recordatorios vía SMS y pasarela de pagos integrada.",
    tags: ["Next.js 16", "Tailwind CSS", "Prisma", "PostgreSQL"],
    metric: "Cero traslapes en citas",
  ...
  {
    id: 2,
    title: "Del Valle Asesores",
    subtitle: "Portal Financiero & Brokerage",
    description: "Dashboard financiero de alta gama para asesoría patrimonial y gestión de pólizas de seguros. Permite cotizar pólizas en tiempo real y visualizar rendimientos complejos.",
    tags: ["Next.js Enterprise", "Recharts", "S3", "Tailwind"],
    metric: "+45% conversión de prospectos",
  ...
  },
  {
    ...
    subtitle: "Infraestructura Autónoma Serverless",
    description: "Diseño e implementación de clusters de Kubernetes redundantes en la nube. Automatización completa de pipelines CI/CD con Docker y despliegues redundantes sin caídas.",
