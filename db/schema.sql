...
-- Limpieza previa para garantizar idempotencia en la inicialización
...
ALTER TABLE users FORCE ROW LEVEL SECURITY; -- Obliga a evaluar políticas para el propietario de la tabla (conexión de la app)
